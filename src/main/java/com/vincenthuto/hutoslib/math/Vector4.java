...
public class Vector4 {
   ...
   public Vector4(Vector3 pVector) {
   ...
   public boolean equals(Object pOther) {
      if (this == pOther) {
         ...
         Vector4 vector4f = (Vector4)pOther;
   ...
   public float dot(Vector4 pOther) {
   ...
   public void lerp(Vector4 pOther, float pDelta) {
      float f = 1.0F - pDelta;
