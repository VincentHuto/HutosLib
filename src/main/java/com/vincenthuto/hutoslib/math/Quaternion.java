...
public final class Quaternion {
	...
	public Quaternion(Vector3 vector3, float pRotationAngle, boolean pDegrees) {
		if (pDegrees) {
	...
	public Vector3f toXYZDegrees() {
		...
		return new Vector3f((float) Math.toDegrees((double) vector3f.x), (float) Math.toDegrees((double) vector3f.y()),
