...
public class HLGuiGuidePageTOC extends Screen {
	...
	protected void init() {
		...
		this.addRenderableWidget(arrowF = new HLButtonArrow(ArrowDirection.FORWARD, ARROWF, left + guiWidth - 18,
				top + guiHeight - 7, (press) -> chapterTemplate.getPages().get(0).getPageScreen(0, book, chapterTemplate)));

		this.addRenderableWidget(
				arrowB = new HLButtonArrow(ArrowDirection.BACKWARD, ARROWB, left, top + guiHeight - 7,
