...
public abstract class GuiGuidePage extends Screen {
	...
	public void render(PoseStack matrixStack, int mouseX, int mouseY, float partialTicks) {
		...
		if (pageNum != 0) {
			GuiUtils.drawMaxWidthString(font, new TextComponent("Pg." + pageNum), left + guiWidth - 26,
	...
	protected void init() {
		...
		this.addRenderableWidget(buttonCloseTab = new GuiButtonTextured(LocationHelper.guiPrefix("book_tabs.png"),
				CLOSEBUTTON, left - guiWidth + 150, top + guiHeight - 193, 24, 16, 24, 32, (press) -> {
					this.onClose();
				}));
