...
public class BoltParticleData {
	...
	public BoltParticleData(BoltRenderInfo info, Vec3 start, Vec3 end, int segments) {
	...
	public static class BoltRenderInfo {
		...
		BoltRenderInfo(float parallelNoise, float spreadFactor, float branchInitiationFactor,
