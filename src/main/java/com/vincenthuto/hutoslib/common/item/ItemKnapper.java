...
import com.vincenthuto.hutoslib.common.block.HLBlockMaterials;
...
public class ItemKnapper extends DiggerItem {
	private static final Tag<Block> EFFECTIVE_ON = HLBlockMaterials.knapper;
	private float speed;
	...
	public boolean canPerformAction(ItemStack stack, net.minecraftforge.common.ToolAction toolAction) {
		return HLBlockMaterials.DEFAULT_KNAPPER_ACTIONS.contains(toolAction);
	}
