...
public class ItemLightningTemplate extends Item {
	public ItemLightningTemplate(Properties properties) {
	...
	public InteractionResultHolder<ItemStack> use(Level level, Player player, InteractionHand usedHand) {
		...
		if (level.isClientSide) {
			EffectTemplateScreen.open(usedHand, EffectTemplateType.LIGHTNING, stack);
		}
