...
public class TestGuiGuideMultiblockPage extends TestGuiGuidePage {
	...
	public TestGuiGuideMultiblockPage(int pageNum, BookCodeModel book, BookChapterTemplate chapter,
