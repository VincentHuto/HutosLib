...
public class ParticleColor {
	public static class IntWrapper {
		public static ParticleColor.IntWrapper deserialize(String string) {
			...
			BigDecimal d4 = d.setScale(0, RoundingMode.DOWN);
			BigDecimal d5 = d1.setScale(0, RoundingMode.DOWN);
			BigDecimal d6 = d2.setScale(0, RoundingMode.DOWN);
	...
	public static ParticleColor averageColors(ParticleColor... colors) {
		...
		return new ParticleColor(runningR / count, runningG / count, runningB / count);
	}
