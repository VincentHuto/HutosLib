package com.hutoslib.client.model.entity;
...
@OnlyIn(Dist.CLIENT)
public class TestMobModel<T extends Mob & RangedAttackMob> extends HumanoidModel<T> {
	public TestMobModel(ModelPart p_170941_) {
		super(p_170941_);
	}
