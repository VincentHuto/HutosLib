package com.hutoslib.client.render.tile;
...
public class RenderTileDisplayPedestal extends TileEntityRenderer<TileDisplayPedestal> {
	public RenderTileDisplayPedestal(TileEntityRendererDispatcher rendererDispatcherIn) {
		super(rendererDispatcherIn);
	}

	@SuppressWarnings("deprecation")
	@Override
	public void render(TileDisplayPedestal te, float partialTicks, MatrixStack matrixStackIn,
		...
		for (int i = 0; i < te.getSizeInventory(); i++) {
			...
			matrixStackIn.rotate(Vector3f.YP.rotationDegrees(angles[i] + (float) te.getWorld().getGameTime()));
			// Edit True Radius
